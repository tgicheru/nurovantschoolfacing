...
const CourseDetails = () => {
  ...
  return (
    <div className={`w-full ${activeType === "mapped" ? "flex gap-4" : ""}`}>
      ...
      {activeType === "mapped" && (
        <div className="h-full w-full lg:w-[383px]">
          <div className="h-[7px] w-full rounded-t-[10px] bg-primary"></div>
          <div className="pt-[24px] px-4 pb-4 flex flex-col gap-4">
            <h3 className="text-[18px] leading-[25px] text-black font-semibold">
              ✨ Suggestions
            </h3>

            <div className="w-full flex flex-col gap-1">
              <p className="text-base font-semibold text-neutral-500">
                Learn to use CSS for transitions
              </p>
              <p className="text-sm text-neutral-500">Relevant Standard:</p>
              <ul className="list-disc w-full pl-4">
                <li className="text-sm text-neutral-500">
                  CSS3 Transition Standards: This is part of the official CSS3
                  specifications that define how to create smooth transitions
                  between different states of an element. It is an essential
                  topic for modern web design, especially for creating
                  interactive web pages.
                </li>
              </ul>
              <p className="text-sm text-neutral-500">Learning Outcomes:</p>
              <p className="text-sm text-neutral-500">
                By the end of this lesson, students should be able to:
              </p>
              <ul className="list-disc w-full pl-4">
                <li className="text-sm text-neutral-500">
                  Apply CSS transitions to elements, changing properties
                  smoothly over a given duration
                </li>
                <li className="text-sm text-neutral-500">
                  Define the transition properties (like transition-property,
                  transition-duration, transition-timing-function, and
                  transition-delay)
                </li>
                <li className="text-sm text-neutral-500">
                  Understand the importance of transform and opacity in creating
                  fluid animations and transitions
                </li>
                <li className="text-sm text-neutral-500">
                  Apply :hover and other pseudo-classes to trigger transitions.
                </li>
                <li className="text-sm text-neutral-500">
                  Create smooth animations using CSS transitions
                </li>
              </ul>
            </div>
          </div>
